 ...
 export default function CreateCommunity() {
     ...
     const handleSubmit = async() => {
         ...
         const res = await axios.post(
             `http://localhost:8080/sharebox/community/create/${user.userId}`,
             {
                 name: data.name,
         ...
         if (res.data.result) {
             ...
             await axios.post(
                 `http://localhost:8080/sharebox/community/${res.data.result.communityId}/upload-avatar`,
                 avatarFormData
             )
             ...
             await axios.post(
                 `http://localhost:8080/sharebox/community/${res.data.result.communityId}/upload-background`,
                 bgImgFormData
             )
